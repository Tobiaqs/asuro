...
*										 LeftRwd(),LeftFwd(),RightRwd(),rightFwd() -> MotorDir(unsigned char left_dir, unsigned char right_dir);
...
/* function to read out line follow phototransistors (left,right) */
...
/* function to read out odometrie phototransistors (left,right) */
